    ...
    def _create_graph(self) -> BaseGraph:
        ...
        search_internet_node = SearchInternetNode(
            ...
            node_config={
                ...
                "max_results": 1, #self.max_results,
        ...
        print('using nodes search_internet_node, graph_iterator_node, merge_answers_node')
...
##idea for scrapegraph AI - use fetch node (as a rag node) to get relevant context when scraping - allows categorical variables in json output, even when there are many options